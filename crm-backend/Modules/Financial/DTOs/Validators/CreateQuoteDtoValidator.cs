...
public class CreateQuoteDtoValidator : AbstractValidator<CreateQuoteDto>
{
    public CreateQuoteDtoValidator()
    {
        ...
        RuleForEach(x => x.LineItems)
            .SetValidator(new CreateQuoteLineItemDtoValidator());
    }
}

public class CreateQuoteLineItemDtoValidator : AbstractValidator<CreateQuoteLineItemDto>
{
    public CreateQuoteLineItemDtoValidator()
    {
