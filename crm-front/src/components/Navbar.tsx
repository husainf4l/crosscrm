      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link
              href="/login"
              className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg flex items-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
        ...
        {isOpen && (
          <div className="md:hidden pb-4 pt-2 border-t border-gray-200">
            <Link
              href="/"
              className="block px-3 py-2.5 rounded-lg text-gray-700 hover:bg-gray-100 font-medium transition-colors duration-200 mb-2"
            >
            ...
            <Link
              href="/login"
              className="block px-3 py-2.5 bg-blue-600 text-white font-semibold rounded-lg transition-colors duration-200"
            >
              <div className="flex items-center gap-2">
                <svg
                  className="w-5 h-5"
